...
class EventRepositoryBuilder extends BaseRepositoryBuilder {
	...
	protected function build() {
		...
		if ($this->area) {
			...
			$this->joins[] = " JOIN meetyournextmp_event_in_area ".
				" ON meetyournextmp_event_in_area.event_id = event_information.id AND meetyournextmp_event_in_area.area_id = :area_id";
