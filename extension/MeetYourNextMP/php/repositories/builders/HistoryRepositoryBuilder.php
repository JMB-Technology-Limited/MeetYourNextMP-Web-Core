	...
	public function fetchAll() {
		...
		if ($this->historyRepositoryBuilderConfig->getIncludeEventHistory()) {
			...
			if ($this->historyRepositoryBuilderConfig->getArea()) {
				...
				$joins[] = " JOIN meetyournextmp_event_in_area ".
					" ON meetyournextmp_event_in_area.event_id = event_history.event_id AND meetyournextmp_event_in_area.area_id = :area_id";
				$params['area_id'] = $this->historyRepositoryBuilderConfig->getArea()->getId();
